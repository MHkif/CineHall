<template>
  <div class="bg-gray-900 h-screen">
    <div class="lg:flex pb-12 md:py-0">
      <div class="lg:w-1/2 xl:max-w-screen-sm">
        <div class="py-4 flex justify-center lg:justify-start lg:px-12 md:py-8">
        ...
        <div
          class="px-8 sm:px-14 md:px-40 lg:px-12 lg:mt-6 xl:px-24 xl:max-w-2xl"
        >
          <div class="mt-8">
            <form
            ...
            >
              <div class="relative space-y-2 self-center"></div>
              <div class="gap-5 flex flex-col md:flex-row md:gap-8">
                <div class="space-y-1 md:space-y-2 w-full">
                  ...
                  <input
                    class="w-full rounded text-sm p-3 border-b border-gray-300 focus:outline-none focus:border-gray-500"
                    type="text"
                    v-model="ref"
                    placeholder="Enter  your ref to login"
                  />
                </div>
              </div>
      ...
      <div
        class="hidden lg:flex items-center justify-center bg-gray-900 flex-1 h-screen"
      >
        <div
        ...
        >
          ...
          >
            ...
            <polygon
              ...
              fill="#616161"
            />
            <circle cx="296" cy="377.06342" r="4" fill="#000" />
            <polygon
...
export default {
  ...
  methods: {
    async login() {
      ...
      if (this.ref != "") {
        await axios({
          url: "http://localhost/CineHall/BackEnd/client/login",
          method: "post",
          data: data,
        })
          .then(async (res) => {
        ...
        Swal.fire({
          icon: "error",
          title: "Failed",
          text: "Please enter your Reference key",
